...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function checkIdcardno(idcardno){
            	...
            	//如果身份证为空，则给出提示
            	if(idcardno == ""){
            		$("#idcardMsg").text("身份证号不能为空！").addClass("error_msg");
            		return ;
            	}
            	//验证身份证号的格式
            	var reg = /^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{4}$/;
            	if(!reg.test(idcardno)){
            		$("#idcardMsg").text("身份证号格式不正确！").addClass("error_msg");
            		return ;
            	}
            	//校验通过，给予提示并移除样式
            	$("#idcardMsg").text("有效的身份证号！").removeClass("error_msg");
            	//根据身份证提取出生日期，赋值给生日字段
    ...
    <body>
        ...
        <div id="main">       
            ...
            <form action="/NetCTOSS/account/add" method="post" class="main_form">
                <!--必填项-->
                ...
                <div class="input_info">
                    <input type="text" name="idcard_no" onblur="checkIdcardno(this.value)" />
                    <span class="required">*</span>
                    <div class="validate_msg_long" id="idcardMsg">正确的身份证号码格式</div>
                </div>
                ...
                <div id="optionalInfo" class="hide">
                    ...
                    <div class="input_info">
                        <input type="text" name="recommenderIdcardno"/>
                        <div class="validate_msg_long">正确的身份证号码格式</div>
                    </div>
                    <div class="text_info clearfix"><span>生日：</span></div>
                    <div class="input_info">
                        <input type="text" name="birthdate" readonly="readonly" class="readonly" id="birthdate"/>
                    </div>
