...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form:form action="/NetCTOSS/admin/${admin.admin_id}" method="put" commandName="admin"  cssClass="main_form"> 
				<div class="text_info clearfix"><span>姓名：</span></div>
                    ...
                    <div class="input_info">
                   		<form:input path="admin_code" name="admin_code" cssClass="readonly" readonly="true"/>
                    </div>
                    <div class="text_info clearfix"><span>电话：</span></div>
                    <div class="input_info">
                        <form:input path="telephone" name="telephone" />
                        <span class="required">*</span>
                        <div class="validate_msg_long error_msg">正确的电话号码格式：手机或固话</div>
                    </div>
                    <div class="text_info clearfix"><span>Email：</span></div>
                    <div class="input_info">
                        <form:input path="email" name="email" cssClass="width200" />
                        <span class="required">*</span>
                        ...
                        <div class="input_info_scroll">
                            <ul>
                            	<c:forEach items="${roles}" var="r">
                                	<li> <form:checkbox path="roleIds" name="roleIds" value="${r.role_id}"/>${r.name }</li>
                            	</c:forEach>
                            </ul>
                        </div>
                        <span class="required">*</span>
