...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">           
            ...
            <form:form action="/NetCTOSS/role/${role.role_id}" method="put" commandName="role" cssClass="main_form">
                <div class="text_info clearfix"><span>角色名称：</span></div>
                <div class="input_info">
                	<form:input path="name" cssClass="width200"/>
                    ...
                    <div class="input_info_scroll">
                        <ul>
                        	<c:forEach items="${pris}" var="p">
	                            <li><form:checkbox path="priIds" value="${p.id}" label="${p.name}"/>
                        	</c:forEach>
                        </ul>
                    </div>
                    <span class="required">*</span>
